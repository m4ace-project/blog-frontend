...
function Login() {
 ...
 const handleSubmit = (e) => {
  ...
  <div className=" text-[#001F54] mt-24  ">
    ...
    <Link  to={'/personalization'} type="submit" className="w-[20vw] font-bold bg-[#FF5722] flex justify-center items-center  rounded-full mt-5 text-white px-20 py-1 text-sm">Continue</Link>
    </div>
    </form>
  </div> 
    </div>
