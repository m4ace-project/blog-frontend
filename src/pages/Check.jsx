...
function Check() {
  return (
    ...
    <div class="mt-6">
        ...
        <img  class="w-[15em] mt-5 mx-auto md:mt-10" src="./Assets/mdi_shield-unlocked-outline.png" alt=""/>
        <div class="flex ml-5 mt-[5em]">
            <img class="w-[15px] h-[15px] mt-3  mr-5 " src="./Assets/mynaui_dots-circle.png" alt=""/>
