    ...
    <div>
      ...
      <div className='text-[#001F54] bg-white mt-5 h-[70vh] w-[60vw] flex flex-col justify-center 
        ...
        <p className='text-center font-bold mt-3 text-xs md:text-base'>Parenting and Family</p>
          ...
          <Checkbox text={'Tina Fey'} id={'ana'}/>
            <Checkbox text={'Jo Frost'} id={'gladys'}/>
            <Checkbox text={'Ruth Soukup'} id={'hh'}/>
            <Checkbox text={'Jessica Joelle Alexander'} id={'pat'}/>
            <Checkbox text={'Alison Gopnik'} id={'huda'}/>
          </div>
        <Subscribe/>
      </div>
