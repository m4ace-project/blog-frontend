    ...
    <div className='bg-[#FFFCD8] h-[100vh] overflow-auto flex'>
      <div className='md:w-[20%]'>
        ...
        <div className='md:w-[80%]'>
            ...
            <div ClassName=''>
            <div className='bg-white px-5 md:px-14 mx-5 md:mx-14 rounded-[2rem]'>
                ...
                <div className=''>
                    <table>
                        <thead>
                            <tr className='grid grid-cols-4 w-full gap-[6rem] md:gap-[13rem] place-self-start py-5'>
                                <th>Username</th>
                                <th>E-mail</th>
                                <th>E-mail Verify</th>
                                <th>Last Activity</th>
                        ...
                        <tbody>
                            <tr className='grid grid-cols-4 gap-[6rem] md:gap-[10rem]  pl-5'>
                                <td>Trendy</td>
                                <td>trendy@gmail.com</td>
                                <td>true</td>
                                <td>2024-09-24 13:05</td>
                            </tr>
                            <tr className='grid grid-cols-4 gap-[6rem] md:gap-[10rem]  pl-5 my-2'>
                                <td>Sita</td>
